// src/components/ClientProfileForm.jsx
...
const ClientProfileForm = () => {
  ...
  return (
    <div>
      {renderField("Display Name", "displayName", "e.g. MoonSeeker42")}
      {renderField("Bio", "bio", "Optional — what are you looking for in a session?")}
